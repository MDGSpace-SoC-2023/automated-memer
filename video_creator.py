    ...
    for comment in os.listdir("static/Audio"):     
        if comment!='title.mp3'and comment!='combined.mp3':
            ...
            if total_length >= 60 or t==gts:
                ...
                output_file = 'static/Background_videos/video.mp4'
                url1 ='https://drive.google.com/u/0/uc?id=1I5Sl-SukvYozqRtdDjteyiFpgvarVKHh&export=download'
                url2 ='https://drive.google.com/u/0/uc?id=1VvbxYTk9OZ8FztebojDfXC6f5_O5FGZ9&export=download'
                url3 ='https://drive.google.com/u/0/uc?id=16aTUJHUdd1ryJAROwk-D-J0yUsvfuhKJ&export=download'
                url4 ='https://drive.google.com/u/0/uc?id=12UbsZE7I4cdlkKup52KKTgRsWOIB37rv&export=download'
                url5 ='https://drive.google.com/u/0/uc?id=1BT_tYSRoHVdphK36l44DJ2pnUGzW4f_S&export=download'
                url6 ='https://drive.google.com/u/0/uc?id=1hnvcx9v4O1STKu9wjxu8Og8VgwseYgw-&export=download'
                url7 ='https://drive.google.com/u/0/uc?id=1lc0NYLewPs-3vmKc5zOKJtcwYCf-byxv&export=download'
                url8 ='https://drive.google.com/u/0/uc?id=1kS0uXqZkHGz6MMwcMn_dmYmY_BKZUBht&export=download'
                ...
                if not os.path.exists("static/Background_videos/video.mp4"):
                    gdown.download(url, output_file, quiet=False)
                
                # Load the title audio file
                title = AudioSegment.from_file("static/Audio/title.mp3")
                ...
                for comment in comments_to_stich:
                    comment_audio = AudioSegment.from_file(f"static/Audio/{comment}")
                ...
                new_audio = AudioSegment.from_file("static/Audio/combined.mp3")
                ...
                screenshots = []
                screenshots.append('static/screenshots/final_screenshots/title.jpg')
                no_of_ss=len(comments_to_stich)
                for ss in comments_to_stich:
                    s=ss.replace(".mp3",".jpg")
                    screenshots.append(f'static/screenshots/final_screenshots/{s}') 
                    
                # Input audio path
                audio_file = 'combined_audio.mp3'  
                output_video = 'static/output_video_without_audio.mp4'
                ...
                input_video = ffmpeg.input("static/output_video_without_audio.mp4")
                trimmed_video = input_video.trim(start=0, end=End[no_of_ss])
                
                added_audio = ffmpeg.input("combined_audio.mp3").audio
                ffmpeg.concat(trimmed_video, added_audio, v=1, a=1).output(f'static/Final_Videos/Final_Video_{i}.mp4').run(overwrite_output=True)
